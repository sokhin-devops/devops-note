...
echo "== Firewall (iptables) Lab Tests =="
echo
...
# 1. Trusted client (172.28.0.20) should be allowed through
...
# 2. Blocked client (172.28.0.30) should be silently dropped (times out)
